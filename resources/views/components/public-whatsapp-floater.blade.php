...
@if ($enabled && strlen($digits) >= 11)
    ...
    >
        ...
        class="flex h-14 w-14 items-center justify-center rounded-full border border-white/15 bg-[#25D366] text-white shadow-2xl transition hover:scale-105 focus:outline-none focus:ring-4 focus:ring-[var(--glow)]"
    >
        ...
        <a
            ...
            title="Visit Us"
            class="flex h-14 w-14 items-center justify-center rounded-full border border-[#f4d27a]/35 bg-[#0f0d0a] text-[#f4d27a] shadow-2xl transition hover:scale-105 focus:outline-none focus:ring-4 focus:ring-[var(--glow)]"
        >
            <svg viewBox="0 0 24 24" aria-hidden="true" class="h-7 w-7 fill-none stroke-current" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
